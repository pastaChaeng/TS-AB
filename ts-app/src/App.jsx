  ...
  const [albums] = useState([
    ...
    },
    {
      ...
      tracks: [
        ...
        { id: 'track14', name: 'Mr. Perfectly Fine', duration: '4:37' },
        { id: 'track15', name: 'We Were Happy', duration: '4:03' },
        { id: 'track16', name: 'That’s When', duration: '4:07' },
        { id: 'track17', name: 'Don’t You', duration: '3:30' },
        { id: 'track18', name: 'Bye Bye Baby', duration: '3:56' },
        { id: 'track19', name: 'Message in a Bottle', duration: '3:18' },
        { id: 'track20', name: 'Forever Winter', duration: '3:58' },
        { id: 'track21', name: 'Run', duration: '4:01' },
        { id: 'track22', name: 'The Very First Night', duration: '3:51' },
        { id: 'track23', name: 'All Night Diner', duration: '3:39' },
        { id: 'track24', name: 'I Bet You Think About Me', duration: '3:24' },
        { id: 'track25', name: 'Don’t You (Taylor’s Version)', duration: '3:31' },
        { id: 'track26', name: 'Forever Winter (Taylor’s Version)', duration: '3:58' },
      ],
    },
    {
      id: 'album3',
      ...
      tracks: [
        ...
        { id: 'track15', name: 'Come Back... Be Here', duration: '3:43' },
        { id: 'track16', name: 'Ronan', duration: '4:25' },
        { id: 'track17', name: 'Girl at Home', duration: '3:41' },
        { id: 'track18', name: 'I Bet You Think About Me (feat. Chris Stapleton)', duration: '3:36' },
        { id: 'track19', name: 'The Moment I Knew', duration: '4:45' },
      ],
    },
    {
      id: 'album4',
      ...
      tracks: [
        ...
        { id: 'track20', name: 'Better Man', duration: '4:21' },
      ],
    },
    {
      id: 'album5',
      name: "1989",
      image: 'https://i.pinimg.com/564x/06/48/c5/0648c56f64db0b667173dac3cd955f16.jpg',
      tracks: [
